...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ClothType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ClothType']) ? $this->services['AppBundle\Form\ClothType'] : $this->services['AppBundle\Form\ClothType'] = new \AppBundle\Form\ClothType()) && false ?: '_'};
